...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-24 lg:py-32 bg-cream text-charcoal" ref={ref}>
      <div className="max-w-7xl mx-auto px-8 sm:px-12 lg:px-16">
        ...
        >
          ...
          <div className="h-px flex-1 bg-charcoal/10"></div>
          <span className="text-sm font-medium text-charcoal/50 uppercase tracking-widest">Get In Touch</span>
        </motion.div>
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <motion.p
            ...
            animate={isInView ? 'visible' : 'hidden'}
            custom={2}
            className="text-charcoal/60 text-base leading-relaxed mb-12 mx-auto max-w-2xl"
          >
          ...
          >
            <a
              href="mailto:rikuspretorius.web@gmail.com"
          ...
          <motion.div
            ...
            animate={isInView ? 'visible' : 'hidden'}
            custom={4}
            className="flex items-center justify-center gap-2 text-charcoal/50 text-sm mb-10"
          >
